...
type Transaction struct {
	...
	AttachmentTime                 decimal.NullDecimal `json:"attachmentTime" gorm:"column:attachmentTime;type:decimal(20,10) NOT NULL"`
	IsValid                        sql.NullBool        `json:"isValid" gorm:"column:isValid;type:tinyint(4) DEFAULT NULL"`
	TransactionCreateTime          decimal.Decimal     `json:"transactionCreateTime" gorm:"column:transactionCreateTime;decimal(20,10) NOT NULL"`
	...
	TransactionConsensusUpdateTime decimal.NullDecimal `json:"transactionConsensusUpdateTime" gorm:"column:transactionConsensusUpdateTime;decimal(20,10) NOT NULL"`
	...
	TrustChainTrustScore           decimal.NullDecimal `json:"trustChainTrustScore" gorm:"column:trustChainTrustScore;type:decimal(20,10) DEFAULT NULL"`
